...
import com.example.qsl.databinding.LayoutTip2Binding;
...
public class TipDialog2 extends Dialog {
    ...
    public TipDialog2(Context context, ClickSureListener clickSureListener) {
        super(context);
    ...
    public void show() {
        ...
        int width = (int) RudenessScreenHelper.pt2px(context, 600);
